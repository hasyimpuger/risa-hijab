...
<title>Risa Hijab | Register</title>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-9" id="content">
          ...
          <p>Jika anda sudah mempunyai akun, silahkan <a href="login.php"><strong>klik disini</strong></a>.</p>
          <form class="form-horizontal" method="post" action="registerakun.php">
            <fieldset id="account">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input-firstname" placeholder="Nama Depan" value="" name="namadepan" required>
                </div>
              </div>
              <div class="form-group required">
                <label for="input-lastname" class="col-sm-2 control-label">Nama Belakang</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input-lastname" placeholder="Nama Belakang" value="" name="namabelakang" required>
                </div>
              </div>
              <div class="form-group required">
                <label for="input-telephone" class="col-sm-2 control-label">Nomor HP</label>
                <div class="col-sm-10">
                  <input type="tel" class="form-control" id="input-telephone" placeholder="Nomor HP" value="" name="nohp" required>
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="password" class="form-control" id="input-confirm" placeholder="Konfirmasi Password" value="" name="confirm" required>
                </div>
              </div>
            </fieldset>
            <div class="buttons">
              <div class="pull-right">
                ...
                &nbsp;Saya setuju dan telah membaca <a class="agree" href="#"><b>Syarat dan Ketentuan</b></a> &nbsp;
